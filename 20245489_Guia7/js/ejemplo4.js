...
buttonAgregarPagina.onclick = function () {
    ...
    if (!contenedorVerificando) {
        ...
        contenedor.setAttribute("style", "border: solid 1px black; height: 50px; overflow: scroll; overflow-x: hidden;");
    ...
    if (contenedor) {
        if (menu.length > 0) {
            ...
            if (titulo != "" && titulo != null) {
                ...
                alert("No se ha registrado ningún titulo, por favor ingrese información");
            }
        } else {
