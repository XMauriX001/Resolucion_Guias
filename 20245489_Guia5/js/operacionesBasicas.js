...
function sumar() {
    let numerol = parseFloat(prompt("Ingrese el primer numero a sumar"));
    let numero2 = parseFloat(prompt("Ingrese el segundo numero a sumar"));
    resultado = numerol + numero2;
    parrafo.innerHTML = `${numerol} + ${numero2} = ${resultado}`;
}

function restar() {
    let numerol = parseFloat(prompt("Ingrese el primer numero a restar"));
...
function multiplicar() {
    let numerol = parseFloat(prompt("Ingrese el primer numero a multiplicar"));
    let numero2 = parseFloat(prompt("Ingrese el segundo numero a multiplicar"));
    resultado = numerol * numero2;
    parrafo.innerHTML = `${numerol} x ${numero2} = ${resultado}`;
}

function dividir() {
    let numerol = parseFloat(prompt("Ingrese el primer numero a dividir"));
    let numero2 = parseFloat(prompt("Ingrese el segundo numero a dividir"));
    let mensaje;
    if (numero2 != 0) {
        resultado = numerol / numero2;
        mensaje = `${numerol} / ${numero2} = ${resultado}`;
    } else {
        mensaje = `El valor ${numerol} / ${numero2} no se puede dividir`;
    }
